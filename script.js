...
const bottomDownloadBtn = document.getElementById('downloadBtn2');
...
if (bottomDownloadBtn) {
    bottomDownloadBtn.addEventListener('click', function(event) {
        event.preventDefault();
        notification.classList.add('show');

        bottomDownloadBtn.style.opacity = '0.7';
        bottomDownloadBtn.style.pointerEvents = 'none';

        const githubLink = bottomDownloadBtn.getAttribute('href');
        if (githubLink) {
        ...
        setTimeout(() => {
            ...
            bottomDownloadBtn.style.opacity = '1';
            bottomDownloadBtn.style.pointerEvents = 'auto';
        }, 3000);
    });
}
